...
namespace Farik
{
    class Program
    {
        ...
        {
            Console.Clear();                                                                        //каждый раз консoль будет очищаться
        ...
        {
            DirectoryInfo d = new DirectoryInfo(@"C:\Users\HP\Desktop");                            //создаем новый директорий d и считываем весь десктоп                   
